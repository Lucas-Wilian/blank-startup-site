// icon:diagram-project | Fontawesome https://fontawesome.com/ | Fontawesome
import * as React from 'react';

function IconDiagramProject(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox='0 0 576 512'
      fill='currentColor'
...
export default IconDiagramProject;
