// icon:bxl-instagram-alt | Boxicons https://boxicons.com/ | Atisa
import * as React from 'react';

function IconBxlInstagramAlt(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox='0 0 24 24'
      fill='currentColor'
...
export default IconBxlInstagramAlt;
